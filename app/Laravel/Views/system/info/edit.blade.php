  ...
  <div class="row">
    <div class="col-md-8">
      ...
      <div class="panel panel-default panel-border-color panel-border-color-success">
        <div class="panel-heading panel-heading-divider">Update Record Form<span class="panel-subtitle"> information.</span></div>
        <div class="panel-body">
          <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group {{$errors->first('first_name') ? 'has-error' : NULL}}">
              ...
              <input type="text" placeholder="" class="form-control" name="first_name" value="{{old('first_name',$info->first_name)}}">
            ...
            <div class="form-group {{$errors->first('last_name') ? 'has-error' : NULL}}">
              <label>First Name</label>
              <input type="text" placeholder="" class="form-control" name="last_name" value="{{old('last_name',$info->last_name)}}">
