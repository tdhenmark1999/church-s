        ...
        <div class="panel-heading">Record Data
          <div class="tools dropdown">
            ...
            <ul role="menu" class="dropdown-menu pull-right">
              <li><a href="{{route('system.info.create')}}">Add new record</a></li>
          ...
          <table class="table table-hover table-wrapper">
            ...
            <tbody>
              ...
              <td class="cell-detail"> 
                ...
                <td class="cell-detail">
                  <span>{{Helper::date_only($info->created_at)}}</span>
                  <span class="cell-detail-description">{{Helper::date_format($info->created_at,"h:i A")}}</span>
                </td>
                <td class="actions">
                    <div class="btn-group btn-hspace">
                      ...
                      <ul role="menu" class="dropdown-menu">
                        <li><a href="{{route('system.info.edit',[$info->id])}}">Edit Record</a></li>
                        <li class="divider"></li>
                        <li><a class="action-delete" href="#" data-url="{{route('system.info.destroy',[$info->id])}}" data-toggle="modal" data-target="#confirm-delete" title="Remove Record">Remove Record</a></li>
                      </ul>
                    </div>
                </td>
              </tr>
              @empty
              <td colspan="4" class="text-left"><i>No record found yet.</i> <a href="{{route('system.info.create')}}"><strong>Click here</strong></a> to create one.</td>
              @endforelse
            </tbody>
          </table>
